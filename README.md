Integrated Lua into Visual Studio by compiling from source. These files are for reference use only. Interpreter is fully functional and all libraries are linked to VS2019.
